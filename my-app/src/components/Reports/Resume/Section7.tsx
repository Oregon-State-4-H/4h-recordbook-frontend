...
import { Section7 } from "@/API/ResumeAPI";
...
function addPageBreaks() {
  ...
  while (i < rows.length) {
    rows.splice(i, 0, <TableHeader key={"Sec7Head-" + count} isBreak={true} />);
    i += 25;
    count++;
  }
}
 ...
 */
export default function Section7Report(props: any) {
  const tableData: Section7[] = props.tableData;
  ...
  return (
    <Page size="LETTER" style={ReportStyles.body} wrap>
        <Text style={ReportStyles.h1}>Section 7: Citizenship/Community Service in 4-H</Text>
        <Text style={ReportStyles.tableHeaading}>List of all 4-H related activitied that contributed to the welfare of my club or community</Text>
