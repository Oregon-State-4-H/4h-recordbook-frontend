        ...
        {Entries.map((item, index) => (
          ...
          >
            <Section7Card
              ...
              Year={item.Year}
              ClubMemberActivities={item.ClubMemberActivities}
