...
import { fetchSectionData, Section4, SectionNumbers } from "../API/ResumeAPI";
...
function Section() {
  ...
  let [allSections, setSections] = useState<Section4[]>([]);
      
  useEffect(() => {
    const getData = async () => {
      try {
        const section1Data = await fetchSectionData<Section4>(SectionNumbers.Section4);
