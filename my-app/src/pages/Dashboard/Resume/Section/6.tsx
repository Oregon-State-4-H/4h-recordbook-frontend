...
import { fetchSectionData, Section6, SectionNumbers } from "../API/ResumeAPI";
...
function Section() {
  ...
  let [allSections, setSections] = useState<Section6[]>([]);
          
  useEffect(() => {
    const getData = async () => {
      try {
        const section1Data = await fetchSectionData<Section6>(SectionNumbers.Section6);
