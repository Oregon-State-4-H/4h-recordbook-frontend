...
import { fetchSectionData, Section8, SectionNumbers } from "../API/ResumeAPI";
...
function Section() {
  ...
  let [allSections, setSections] = useState<Section8[]>([]);
              
  useEffect(() => {
    const getData = async () => {
      try {
        const section1Data = await fetchSectionData<Section8>(SectionNumbers.Section8);
