...
const Entries = [
  {
    ...
    ContestOrEvent: "Coursework",
    RecognitionReceived: "PWA",
    Level: "Beginner",
  },
  {
    ID: "222",
        ...
        {Entries.map((item, index) => (
          ...
          >
            <Section12Card
              ...
              Year={item.Year}
              ContestOrEvent={item.ContestOrEvent}
              RecognitionReceived={item.RecognitionReceived}
              Level={item.Level}
            />
          </Box>
        ))}
