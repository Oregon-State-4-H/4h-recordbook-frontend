...
import { fetchSectionData, Section5, SectionNumbers } from "../API/ResumeAPI";
...
function Section() {
  ...
  let [allSections, setSections] = useState<Section5[]>([]);
        
  useEffect(() => {
    const getData = async () => {
      try {
        const section1Data = await fetchSectionData<Section5>(SectionNumbers.Section5);
