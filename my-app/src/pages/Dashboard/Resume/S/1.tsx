...
export default function Section() {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const section1Data = await fetchSectionData<Section1>(
          SectionNumbers.Section1
        );
          ...
          allSections.map((item, index) => (
            ...
            >
              <Section1Card
                ...
                num_in_club={item.num_in_club}
                club_leader={item.club_leader}
                meetings_held={item.meetings_held}
                meetings_attended={item.meetings_attended}
